    ...
    return (
        <body>
            <div class="page">
                <div class="header">
                    <div class="container">
                        <p class="title">Privacy Policy for wenevr</p>
                    </div>
                </div>
                    ...
                    <div class="container">
                        <div class="tab-content translations-content-item en visible" id="en">
                            ...
                            <ul>
                                ...
                                <li>
                                    <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to wenevr.</p>
                                </li>
                                <li>
                                ...
                                <li>
                                    <p><strong>Website</strong> refers to wenevr, accessible from <a href="https://directed-study-tr8y.vercel.app/" rel="external nofollow noopener" target="_blank">https://directed-study-tr8y.vercel.app/</a></p>
                                </li>
                                <li>
                            ...
                            <ul>
                                <li>By visiting this page on our website: <a href="https://directed-study-tr8y.vercel.app/privacy" rel="external nofollow noopener" target="_blank">https://directed-study-tr8y.vercel.app/privacy</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
